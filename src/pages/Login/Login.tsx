      ...
      >
        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate sx={{ mt: 1 }}>
          <Controller
            ...
            rules={{
              required: { value: true, message: t('login.emailIsRequired') },
              pattern: { value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i, message: t('login.emailIsInvalid') },
            }}
          />
          <Controller
            name="password"
            ...
            rules={{ required: { value: true, message: t('login.passwordIsRequired') } }}
          />
